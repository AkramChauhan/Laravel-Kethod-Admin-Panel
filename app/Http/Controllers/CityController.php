...
use App\Http\Requests\CityRequests\AddCityRequest as AddRequest;
use App\Http\Requests\CityRequests\UpdateCityRequest as UpdateRequest;
use App\Models\City as Table;
use Exception;
...
{
    protected $handle_name = "city";
    protected $handle_name_plural = "cities";
