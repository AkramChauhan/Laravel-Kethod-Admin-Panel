...
use App\Http\Requests\StateRequests\AddStateRequest as AddRequest;
use App\Http\Requests\StateRequests\UpdateStateRequest as UpdateRequest;
use App\Models\State as Table;
use Exception;
...
{
    protected $handle_name = "state";
    protected $handle_name_plural = "states";
