...
use App\Http\Requests\ZipcodeRequests\AddZipcodeRequest as AddRequest;
use App\Http\Requests\ZipcodeRequests\UpdateZipcodeRequest as UpdateRequest;
use App\Models\Zipcode as Table;
use Exception;
...
{
    protected $handle_name = "zipcode";
    protected $handle_name_plural = "zipcodes";
    ...
    public function ajax(Request $request)
    {
        ...
        if (isset($request->string)) {
            ...
            $modalObject = $modalObject->where('zipcode', 'like', "%" . $request->string . "%");
            // $modalObject = $modalObject->orWhere('name','like',"%".$request->string."%");
        }

        $total_records = $modalObject->count();
        $modalObject = $modalObject->orderBy('population','desc');
